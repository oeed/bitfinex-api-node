...
class Rest2 {
    ...
    makePublicRequest(name, cb = this.genericCallback.bind(this), qs) {
    ...
    trades({
        ...
        return this.makePublicRequest(`trades/${symbol}/hist`, cb, {
            limit: limit,
            start: start,
            end: end,
            sort: -1
    ...
    alertSet(type = 'price', symbol = 'tBTCUSD', price = 0) {
        return this.makeAuthRequest(`/auth/w/alert/set`, {
            type,
            symbol,
            price
        })
